 ...
 * contains {@link #APP_NAME}, {@link #VERSION} and {@link #AUTHOR}, and
 * shutdown hook.
 * 
 * @author martin
 * 
...
public class KHMain {
	...
	public static void main(String[] args) {
		if (args.length == 1 && //
				(args[0].equals("-h") || args[0].equals("--help") || args[0].equals("-v")
		...
		Runtime.getRuntime().addShutdownHook(new ShutdownHookThread(/* frame, */ config));
	...
	private static void registerExcetptionHandlers() {
		...
		System.setProperty("sun.awt.exception.handler", handler.getClass().getName());
